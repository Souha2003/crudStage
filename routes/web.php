...
Route::get('/soutenances', [SoutenanceController::class, 'index'])->name('stageDinitationInterface');

Route::post('/soutenances/ajouter', [SoutenanceController::class, 'ajouter'])->name('soutenances.ajouter');

Route::get('/soutenancesliste', [SoutenanceController::class, 'showAll'])->name('stageDinitationInterface');


Route::get('/soutenances/{id}/edit', [SoutenanceController::class, 'edit'])->name('soutenances.edit');
Route::patch('/soutenances/{id}', [SoutenanceController::class, 'update'])->name('soutenances.update');
...
Route::delete('/soutenancessupprime/{id}', [SoutenanceController::class, 'destroy'])->name('soutenances.destroy');

Route::get('/search', [SoutenanceController::class, 'search'])->name('students.search');
